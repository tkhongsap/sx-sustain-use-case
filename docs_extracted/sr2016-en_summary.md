...
ThaiBev selected sustainability issues consistent with its business operations, focusing on topics relevant to ThaiBev in the following categories:

- **Consistency with Megatrends and Strategies:**
  - Aligns with ThaiBev’s future strategies and missions.
  - Matches ThaiBev’s material issues from 2014 and 2015.
  - Aligns with international standards like SASB, GRI, and DJSI.

- **Industry and Global Trends:**
  - Consistency with trends in the global food and beverage industry.
  - Aligns with the National Social and Economic Development Plan No. 12 and the UN’s Sustainable Development Goals.

ThaiBev collaborated with relevant experts to identify issues most pertinent to its strategy. As a result, 17 topics were identified as crucial for ThaiBev's present and future.
...
The matrix illustrates the impact and opportunities for ThaiBev, with a focus on economic, environmental, and social aspects.
...
- A doctorate program in biotechnology at the Faculty of Agro-Industry, Kasetsart University.
...
- **16% Reduction of Energy Intensity**
  - Reduction of 34.55 MJ/hL FGs
  - Compared to 2014

- **13% Reduction of Electricity Intensity**
  - Compared to 2014

- **303.25 Million Baht**
  - Savings from replacing fuel oil with renewable energy in 2016

- **12% Reduction of Greenhouse Gas Emission Intensity Scope 1**
  - Compared to 2014

- **13% Reduction of Greenhouse Gas Emission Intensity Scope 2**
  - Compared to 2014
...
Energy efficiency is ThaiBev's prime concern. ThaiBev has set targets for the year 2020 to reduce energy consumption by 5% compared to 2014. To achieve this goal, ThaiBev will focus on using research and technology to develop new alternative renewable energy sources that can help reduce the environmental impact of its processes and achieve sustainable economic growth at the same time.
...
- **Renewable energy**: Biogas, concentrated distillery slop, and by-product from alcohol at 90 and 70% alcohol.
- **Non-renewable energy**: Heavy fuel oil, natural gas, C⁺, bituminous coal, gasoline, and diesel fuel.
...
- **BIOGAS**: 58% of ThaiBev’s production sites have installed biogas systems. Additionally, there is a biogas plant in Phra Nakhon Si Ayutthaya province under construction, ready to operate in 2017. ThaiBev is conducting feasibility studies to establish three more biogas factories in Nong Khai province, Nakhon Sawan province, Ratchaburi province.
...
- **BIOMASS**: ThaiBev’s plant, powered by energy from biomass, is under construction in Kanchanaburi province, with operations commencing in 2018. The plant will help reduce the use of heavy fuel oil. The Company expects to sell surplus electricity to the Provincial Electricity Authority.
...
**Note**: The energy consumption includes non-renewable energy such as coal, diesel fuel, fuel oil, LPG, natural gas, C⁺; and renewable energy which are biogas from waste production, concentrated distillery slop, and by-products from 90 and 70% alcohol as well as electricity and steam purchased from other organizations.

# Major Projects for 2016

| Project's Detail                                                                 | Savings                                                                 |
|----------------------------------------------------------------------------------|-------------------------------------------------------------------------|
...
| VSDs are installed at various motor engines such as water pumps, cooling towers, and blowers. VSD helps control motor speed to reduce energy consumption while maintaining a high efficiency. | 1.81 million baht has been saved.                                       |
| **Installing energy saving fan for evaporative condensers**                      |                                                                         |
| Fan blades made of Fiber-glass Reinforced Plastic (FRP) have been installed to replace heavy aluminum blades. A previous trial in 2015 shows 20% of energy reduced by FRP fans. | 160,000 baht has been saved.                                            |
|                                                                                  | 180,093.60 MJ/year of energy has been saved.                            |
| **Improving boiler efficiency by installing "Economizer" tubular heat**          |                                                                         |
...
| **Installing "Heat Exchangers" to recover heat from ammonia gas to heat the boiler makeup water** |                                                                         |
| After the installation of the heat exchanger, heat from ammonia gas at 100°C can increase the temperature of the boiler makeup water from 30°C to 60°C and the ammonia gas’s temperature will be reduced from 100°C to 60°C. | This resulted in using less electricity in the condenser which saves 1,866,400 MJ/year and saves more than 500,000 baht. |

# Energy Management and Consumption

In 2016, ThaiBev reduced its energy intensity by 20 megajoules per hectoliter of Finished Goods (MJ/hL FGs), accounting for a 10% reduction in energy use from 2015. This was achieved through increased use of renewable energy and staff education on energy conservation, demonstrating ThaiBev's commitment to sustainable energy management.
...
- **Energy consumption**: Amount of fuel used × estimated heating value of each fuel type.
- **Conversion unit**: Based on standards by the Ministry of Energy for energy consumption rates.
- **Total energy consumption intensity**: Total fuel consumption (non-renewable + renewable) + total electricity and steam purchased, divided by production volume. Measured in MJ/hL FGs.

ThaiBev has implemented Total Productive Maintenance (TPM) for maintaining tools, machines, and equipment to save energy.
...
Thai Beverage Logistics Company Limited (TBL) provides logistic services for alcoholic and non-alcoholic beverages. TBL offers warehousing, transportation, and distribution services to customers, helping reduce CO₂ emissions by using fuel sustainably. The company has expanded to cover 68 warehouses. The two distributing centers and the transportation center under "4DX Trim-tab Certification" achieved a 100% "Delivery in Full on Time" index or DIFOT. Efficient transportation between provinces from January to September 2016 saved 171,335 liters of fuel, equivalent to 470 metric tons CO₂e.

In 2016, ThaiBev's greenhouse gas emission intensities were lower than in 2015, demonstrating the company's ability to increase production while reducing environmental impact.
...
| 2015 | 0.0059                  | 0.0091                    | 0.0150                        |
| 2016 | 0.0084                  | 0.0054                    | 0.0137                        |

### Notes:
- For 2016, ThaiBev aligned its total energy consumption reporting period with its financial reporting, covering 9 months from January to September 2016, updating greenhouse gas emission factors for accuracy.
- ThaiBev's Greenhouse Gas Emission table includes carbon dioxide (CO₂), methane (CH₄), and nitrous oxide (N₂O). Emission intensity from used fuel and refrigerant coolants is measured in metric tons CO₂ per hectoliter of Finished Goods (tCO₂e / HL FGs). Standards from the Carbon Footprint for Organisations (CFO) and guidelines from Thailand Greenhouse Gas Management Organization are used, with additional references from the IPCC 4th Assessment Report.

## ThaiBev's Commitment to Reducing Emissions

ThaiBev is actively enhancing its capacity to reduce greenhouse gas emissions. The company follows guidelines from the Thailand Greenhouse Gas Management Organization and has joined the "Carbon Footprint for Organization Program" with the Federation of Thai Industries. In 2016, five subsidiaries received approval to use the 'Carbon Footprint for Organization Label.'

### Air Pollution

ThaiBev prioritizes reducing air pollution by adhering to standards from the United States Environmental Protection Agency (U.S. EPA). The company monitors emissions to manage dust particles, nitrogen dioxide (NO₂), and sulfur dioxide (SO₂) as per the Ministry of Industry's regulations.

### Air Pollution Reduction Systems

ThaiBev has implemented systems to reduce air pollution, including:

- **Gas washers**: Reduce sulfur release in gas and prevent steam generator erosion.
- **Oxygen trims**: Control oxygen in combustion to ensure complete combustion without excess air.
- **Bag filter cyclones and wet scrubbers**: Filter dust, gas, and small particles from boiler stacks.

![Carbon Footprint for Product Label](image)
...
- **Effluents**: ThaiBev treats its effluents to the highest standard and fully complies with laws and regulations.

- **Waste**: ThaiBev effectively manages its waste to ensure full compliance with laws and regulations.
...
ThaiBev places great importance on the utilization of renewable energy. In ThaiBev’s alcohol distilleries, there is a large amount of vinasse – the wastewater from the distillation process. ThaiBev uses evaporation to concentrate the vinasse as well as reducing the odor. This concentrated vinasse is a suitable replacement for fuel oil in the incinerator/boiler system. This is a crucial part of ThaiBev's waste-to-energy strategy and enables ThaiBev to produce 144,000 metric tons of steam per year.
...
| 2015 | 0.093         | 0.007           | 1.346            | 0.1559         | 1.995      |
...
- **67%** Reduction of valuable waste intensity compared to 2014
- **47%** Reduction of hazardous waste intensity compared to 2014
- **38%** Reduction of general waste intensity compared to 2014
- **26%** Reduction of total waste intensity compared to 2014

# Case Study: Solid Waste to Energy

ThaiBev continues its research and development efforts on recycling and converting waste from its production processes into energy. ThaiBev annually converts:
- 0.4 metric tons of soot from boiler stacks
- 30 metric tons of dried sludge
- 0.8 metric tons of scale from distillation columns into charcoal briquettes

Facilities using coal as a source of energy can convert soot into charcoal briquettes, providing 3,650 kcal/kg heating value. If fully used, they would provide the equivalent of 6 gigajoules of energy. This offers ThaiBev low-cost energy for its production processes, which can also be distributed to surrounding communities.

# Case Study: By-Products to Animal Feed

ThaiBev has established Feed Addition Co., Ltd. under the Thai Beverage Group to manage by-products from the spirits and beer business groups. By-products such as:
- Wet malt residue
- Dried malt residue
- Dry yeast

These are sold to feed mills or directly to livestock farmers, providing high-quality, chemical-free materials with high nutritional value. By-products like settled solid, vinasse ash, and other sludge, which have high nutrients for plants, are sold as raw materials to fertilizer manufacturing facilities.

# Case Study: By-Products to Agricultural

Feed Addition Co., Ltd., in cooperation with Kasetsart University, conducts research and development on using by-products from distilleries and breweries to produce soil supplements containing organic matter and high nutrients suitable for organic farming. ThaiBev started the experiment in a sugarcane demonstration plot and distributed the soil supplements to farmers working near ThaiBev's facilities for organic farming.

# Post-consumption Packaging Management

ThaiBev is committed to reducing plastic in its packaging and focuses on integrated post-consumption packaging management, especially for plastic bottles and aluminum cans, through partnerships with packaging recycling companies. ThaiBev has established Thai Beverage Recycle Co., Ltd. to buy back and recycle:
- Glass bottles
- Scrap glass
- Paper briquettes
- Corrugated box partitions

ThaiBev currently recycles more than 40 thousand metric tons of these materials. Additionally, ThaiBev partners with companies using plastic weaving technology to recycle plastic from packaging into clothes, bulletproof vests, and auto parts.

# Food Waste Management

ThaiBev is committed to reducing food waste through efficiency management throughout the value chain. ThaiBev emphasizes the monitoring of food waste from the production process and the improvement of its processes and machinery, especially in ThaiBev’s food production process at Oishi Central Kitchen, the main producer of food products for Oishi restaurants and retail distribution.
...
![SDGs](https://upload.wikimedia.org/wikipedia/commons/thumb/3/3b/Sustainable_Development_Goals_chart.svg/1200px-Sustainable_Development_Goals_chart.svg.png)
...
ThaiBev's social activities are grouped into five key areas. In 2016, ThaiBev invested 450 million baht in social development projects in the following sectors:
...
Following the principles of SEP and the example set by His Majesty King Bhumibol Adulyadej, ThaiBev is dedicated to helping develop communities in a sustainable and sensitive way. This involves:

- Learning about each specific community by engaging with residents directly.
- Aiming to let the community manage itself.
- Offering assistance where truly needed, such as strategic, logistical, or monetary support.

Truly collaborative community development efforts are more likely to succeed and provide a sustainable model applicable to other sectors.

### ThaiBev's Approach

ThaiBev prioritizes establishing good working relationships with communities, leading to the sustainable development of both communities and businesses. The focus is on participation, contribution of ideas, and bringing diverse projects to the developing community. ThaiBev also aims to:

- Improve cooperation between communities and factories.
- Project a positive and sustainable image to the surrounding community.

### Criteria for Initiatives

ThaiBev has set out criteria for undertaking initiatives by dividing target communities into two groups:
...
# ThaiBev Community-Based Projects Overview
...
ThaiBev is committed to helping districts support and strengthen each other, focusing on sustainable business practices and the country's sustainable development. The company aims to enhance community networks and partnerships, boosting their businesses and economies.

### Key Objectives:
- Develop the community's economy.
- Reduce expenses and increase income without negative impacts on people or the environment.

### Initiatives:
- Collaboration within communities.
- Establishment of the Five-Forces Model (Pracharath).
- Development of working forums or task forces for bi-lateral parties within communities.

Each task force includes:
- A community leader.
- A bi-lateral party of local government and private sector leaders.
- Collaboration to survey and develop a database on community economies.

### Implementation:
In 2016, ThaiBev launched the Better Occupations Initiative with partners in:
- Bua Yai in Nan province.
- Pone Thong in Chaiyabhum province.
- Khaotran in Surat Thani province.

### Example Product:
- **Kao Mee Soob Organic Sprouted Brown Rice**: Developed for food-processing workgroups in Pone Thong district.
...
- **To reduce the costs of rice and vegetable farming:**
...
— **Nanta Pajtanee**, Smart Farmer 2016 and President of Organic Brown Rice Processing, Pone Thong, Chaiyaphum province
...
![Blanket Donation](https://example.com/image.jpg)

**3,400,000**  
blankets have been donated in the past 17 years.

## ThaiBev and the Pracharath Policy

The government’s policy aims to reduce inequality, enhance competitive capability, and develop human resources throughout the nation. It brings together the private sector and civil society to build a stable, prosperous, and sustainable country. The Cabinet has established two joint steering committees among public, private, and community sectors to implement the Pracharath Policy. 

One of these is led by General Anupong Paochinda, Minister of Interior, and Mr. Thapana Sirivadhanabhakdi, President and CEO of Thai Beverage Plc., as leaders in public and private sectors, respectively. The objective of this committee is to generate income for the community, establish a strong community economy, and contribute to the happiness of the people.
...
2. **Creating Know-how**
3. **Marketing**
4. **Communication and Management (Creating Awareness of Sustainability)**
...
## Commitment
- Collaborate among the 5 sectors (public, private, academic, civil society, and individuals) to solve problems and build the future of Thailand, reducing inequality and enhancing competitive capability.

## Goal
- Generate income for the community and create happy inhabitants.

## Challenges
- Establish a managing system that can sustain these collaborations.
- Lay the foundation for each company’s good governance.
- Ensure that community generates income sustainably.

## Opportunities
- Build a platform for every sector to genuinely work together to create sustained benefits for the community.
- Create links between the economies of communities, provinces, and regions across Thailand.

## Process
- Increase community income and improve quality of life in a sustainable manner for the 3 occupational categories through 5 processes across 76 provinces:
  1. Access to Factors of Production
  2. Creating Know-how
  3. Marketing
...
### Internal
- Employees involved in volunteer work by assisting and educating community members.
...
- Approximately 25 million Thais work in agriculture.
- Average household income: 50,000 baht/year.
- Below average living wage: 100,000 baht/year.
- National problem to be addressed by five sectors:

  1. **Public Sector**: Implement policies for infrastructure and support via financial institutions.
  2. **Private Sector**: Teach management strategies, create marketing networks, and provide business planning.
  3. **Academic Sector**: Offer research-based know-how and develop manufacturing technology.
  4. **Civil Society**: Strengthen community networks.
  5. **Individuals**: Engage in production, service provision, and business operations.

### Monitoring Indicators: KPIs & Targets

1. **Increase Household Income**
   - Collect and analyze household income data through the government’s basic needs database.

2. **Raise Prices of Community Products to Generate Sustained Income**
   - Pracharath Rak Samakkee (Province) Co., Ltd. will organize product registration and monitor production volumes and prices.

3. **Sustainably Reduce Poverty in the Community**
   - Extend knowledge to communities to foster self-reliance.
   - Measure results using data from the National Economic and Social Development Board.
...
The Ministry of Interior, in collaboration with the Public-Private Steering Committee, the Royal Initiative Discovery Foundation, the Royal Lives Development Foundation, and leading modern trade entrepreneurs in Thailand, has distributed 3,244 metric tons of longkong under this initiative. The fruits were bought at 6–30 baht per kilogram, above the market price of 5 baht per kilogram. To support long-term development, vacuum packaging was developed to extend shelf life, and a product separation standard was implemented. Farmers received training on making longkong ice-cream and juice as pilot products to test market response.

## Pracharath Samakki (Chiang Mai) Co., Ltd.
Longan farmers from Kuamoong village in Sarapee district were assisted in finding new distribution channels to eliminate middlemen and sell directly to buyers, increasing earnings from 18 baht to 38 baht per kilogram.

Additionally, the Committee supported the Phuket Lobster event from 1–31 August 2016. Pracharath Rak Samakkhi (Phuket) Co., Ltd. created a campaign to market the renowned local Phuket Lobster, also known as the Painted Spiny Lobster, to tourists worldwide. The initiative aims to generate income for local communities breeding spiny lobsters, with the Tourism Authority of Thailand (TAT) estimating income flows of 100 million baht.

# Processors

## Thai Loincloth (Pa Kaw Mar) Thai Crafts Initiative
Select loincloths (Pa Kaw Mar) with distinct patterns and a clear background story were made into new products designed by leading designers, adding value to community-made products. This initiative conserves Thai culture by teaching the community to turn raw materials into uniquely patterned loincloths. Each province's loincloth has a distinctive character that could be registered and trademarked, leading to increased distribution in Thailand and abroad.

## The Household Rice Miller Initiative
This initiative allows villagers to mill their own rice to their desired quantity and time, creating new distribution channels where farmers can sell rice directly to consumers at higher prices and establish direct relationships with buyers. Consumers can choose from different types of rice species, from different areas, and mill it themselves.

## Batik Design Week
Held from 24–28 September 2016 in Phuket, hosted by Pracharath Rak Samakkhi (Phuket) Co., Ltd., and in 5 provinces on the Andaman Coast and 5 southern-border provinces, hosted by the Community Development Department. Total sales exceeded 2 million baht, with more orders being placed regularly.
...
![Bhumirajanakarindra Kidney Institute Hospital](https://example.com/image.jpg)
...
1. **The Artificial Blood Vessel Surgery Project**: In honor of Her Royal Highness Princess Maha Chakri Sirindhorn on her 60th birthday on 2 April 2015.
   
2. **The 600 Kidney Transplants Project**: In honor of Her Royal Highness Princess Maha Chakri Sirindhorn on her 60th birthday on 2 April 2015.

3. **Cooperation with the Department of Promotion and Prevention of Kidney Disease**: Workshop on "The Founding of a Clinic to Delay Kidney Failure for Patients with Chronic Kidney Disease," held in Kamphaeng Phet province.

4. **Disseminating Information**: Free public education every three months on proper diets for diabetes, high blood pressure, and kidney disease. This includes patients and their relatives, who can learn about potential complications like disability and paralysis. The project is organized regularly, with the 15th session in December 2016.

## Chang Clinic

Chang Clinic is a special mobile medical unit in Klong Klung district, Kamphaeng Phet province, treating employees and the general public for the last 10 years. It features expert health professionals from renowned hospitals providing medical advice. The project charges for drugs at cost to meet community needs.

# Sport

ThaiBev has supported sport continuously for over 20 years, recognizing the importance of Thai sport. The Company's goal is to inspire youth and others to improve quality of life through sport initiatives, benefiting Thai society as a whole. This approach builds quality members of society through sportsmanship and strengthens partnerships with the Company.

ThaiBev has promoted nearly every category of sport in Thailand—both international and traditional—with an emphasis on sustainable development.

Today, football is a major sport globally. ThaiBev's support extends to other sports like golf, volleyball, tennis, snooker, etc. Additionally, ThaiBev supports Thai boxing (Muay Thai) and Thai long boat racing, reflecting Thai culture and lifestyle.

Lessons from previous projects have been integrated into a unique approach to build strong sport networks, improving every level of sport with determination.

## THAIBEV SPORT PERFORMANCE

| Level         | Sports and Activities                                                                 |
|---------------|---------------------------------------------------------------------------------------|
| **GLOBAL**    | - **Football**: International Club Partner (Everton FC, FC Barcelona) <br> Team Sponsorship (Thailand National Team Football) <br> - **Volleyball**: Team Sponsorship (Thailand National Team Volleyball) <br> FIVB Volleyball World Grand Prix <br> - **Snooker**: International Tournament (SangSom 6 Red World Snooker Championship) |
| **NATIONAL**  | - Official Partner: Football Association of Thailand <br> Thailand Volleyball Association <br> Lawn Tennis Association of Thailand <br> Billiard Sport Association of Thailand |
| **PROFESSIONAL** | - **Football**: Chang FA Cup Football Tournament <br> Club Sponsorship 30 Football Clubs / 2 Futsal Clubs <br> - **Long boat**: Tournament (Thai Traditional Long Boat Tournament) <br> - **Snooker**: Tournament (Snooker SangSom 6 Red Thailand Championship) <br> - ThaiBev Thai Talent Athletes: Snooker, Golf, Tennis |
| **AMATEUR**   | - **Football**: Chang Amateur Football Tournament <br> Chang Mobile Football Unit <br> Chang AFC License Coaching Clinic <br> - **Volleyball**: Thailand Volleyball Championship <br> - **Snooker**: SangSom Snooker Clinic by Tai Pichit <br> - **Golf**: Chang Thailand Junior Golf Circuit |
| **YOUTH**     | - **Football**: Chang Junior Football Camp/Clinic <br> Chang Career Camp <br> Chang Soccer School Scholarship <br> - **Volleyball**: Chang Volleyball Camp <br> - **Tennis**: Chang Tennis Clinic <br> - **Golf**: Chang Junior Golf Clinic, Air Force Youth Academy <br> - **Long boat**: Thai Traditional Long Boat Young Competitor |
...
| Year | Number of People Participating in Activities |
|------|---------------------------------------------|
| 2013 | 78,847                                      |
| 2014 | 82,142                                      |
| 2015 | 83,874                                      |
...
- **Educational Opportunities**: 
  - Created and distributed learning opportunities to disadvantaged youths in over 100 districts across 40 provinces.
  - Notable areas include Baan Karuna in the Samut Prakarn province and Monjaem community in Chiang Mai province.

- **Football Development**:
  - Produced a National Youth Football Team and developed more than 50 professional footballers.
  - Trained over 200 qualified football trainers with C to B licenses, contributing to a quality workforce with a positive attitude towards football and Thai society.

- **National Football Success**:
  - The Thai national football team became the champion of five Southeast Asian Games and the Asean Football Federation (AFF) in 2015.
  - The female national football team reached the final round of the FIFA World Cup in 2015, ranking 12th.
  - Achieved success in various national tournaments.
...
- **Bangkok**
  - Thefara Football Academy (TFA): 700 participants

- **Surat Thani**
  - Suratthani 2 Provincial Administration Organization School: 600 participants

- **Surin**
  - Chaimongkol Sub-district Administrative Organization: 750 participants
  - Ban Tronchai School: 700 participants
  - Si Narong Stadium: 600 participants
...
- **Football Network**
  - Built a powerful network through activities across the country.
  - Efficient operations in over 30 districts involving local residents, institutions, and organizations.

- **Quality Personnel**
  - Created a team of quality personnel.
  - Established collaborations and networks through sporting activities.
...
*H.R.H Princess Maha Chakri Sirindhorn graciously presides over the grand opening of "The Photos of the Kingdom" exhibition at The Street Ratchada on 15 August 2016.*
...
| Indicators     | Material Aspects                  | Unit                | 2013       | 2014       | 2015       | 2016       |
|----------------|-----------------------------------|---------------------|------------|------------|------------|------------|
|                | Ethane (C₂ gas)                   | Percent             | 3.5        | 2.1        | 0.3        | 0.02       |
...
|            | ThaiBev Group    | Persons | 23,868 | 14,796 | 23,588 | 14,791 | 24,057 | 15,278 | 24,710 | 15,992 |
...
|            | New employee hires | | | | | | | | | |
|            | Total number of new hires | Persons | 3,706  | 4,401  | 3,492  | 4,641  | 4,825  | 4,902  | 3,766  | 3,706  |
|            | ThaiBev Group    | | | | | | | | | |
|            | Total new hires  | Persons | 3,706  | 4,401  | 3,492  | 4,641  | 4,825  | 4,902  | 3,766  | 3,706  |
...
# Sustainability Report - Thai Beverage Public Company Limited
...
| Material Aspects                          | Unit                     | 2013 | 2014 | 2015 | 2016 |
|-------------------------------------------|--------------------------|------|------|------|------|
|                                           |                          | Male | Female | Male | Female | Male | Female | Male | Female |
...
We have provided ThaiBev with a Management Report with our findings and recommendations. Without affecting the conclusions presented above, we have the following key observation:
...
| G4-41    | Process for the highest governance body to ensure conflicts of interest are avoided and managed | Please refer to ThaiBev’s Corporate Governance Report: [Link](http://www.thaibev.com/th08/aboutus.aspx?subly1gID=139) | - | - |
| G4-44    | Evaluation of the highest governance body’s performance | Please refer to ThaiBev’s Corporate Governance Report: [Link](http://www.thaibev.com/th08/aboutus.aspx?subly1gID=139) | - | - |
| G4-46    | Highest governance body’s role in reviewing the organization’s risk management processes | Please refer to ThaiBev’s Corporate Governance Report: [Link](http://www.thaibev.com/th08/aboutus.aspx?subly1gID=139) | - | - |
...
| Profile   | Page/Link/Comment | External Assurance | UN SDGs Mapping Linkage to Disclosure |
|-----------|-------------------|--------------------|---------------------------------------|
| G4-DMA    | Disclosure on Management Approach | 32-35 | - | 12 |
...
| G4-LA11  | Percentage of employees receiving regular performance and career development reviews | 51, 136-137 | Yes | |
...
| **Child Labor**                                                                                   |                   |                    |                                       |
| G4-DMA        | Disclosure on Management Approach                                                 | 33, 53            | -                  |                                       |
| G4-HR5        | Operations and suppliers identified as having significant risk for incidents of child labor, and measures taken to contribute to the effective abolition of child labor | 33, 53            | -                  | 8, 16                                 |
| **Forced or Compulsory Labor**                                                                    |                   |                    |                                       |
| G4-DMA        | Disclosure on Management Approach                                                 | 33, 53            | -                  |                                       |
| G4-HR6        | Operations and suppliers identified as having significant risk for incidents of forced or compulsory labor, and measures taken to contribute to the elimination of all forms of forced or compulsory labor | 33, 53            | -                  | 8                                     |
| **Assessment**                                                                                   |                   |                    |                                       |
| G4-DMA        | Disclosure on Management Approach                                                 | 33               | -                  |                                       |
| G4-HR9        | Total number and percentage of operations that have been subject to human rights reviews or impact assessments | 33               | -                  | 12                                    |
| **Supplier Human Rights Assessment**                                                              |                   |                    |                                       |
| G4-DMA        | Disclosure on Management Approach                                                 | 33, 53            | -                  |                                       |
| G4-HR10       | Percentage of new suppliers that were screened using human rights criteria        | 33, 53            | -                  | 12                                    |
|               | Please refer to the ThaiBev Supplier Code of Practice (http://www.thaibev.com/en08/sustainability.aspx?subv1gID=169) |                    |                    |                                       |
| **Local Communities**                                                                             |                   |                    |                                       |
| G4-DMA        | Disclosure on Management Approach                                                 | 11, 96-125        | -                  |                                       |
| G4-SO1        | Percentage of operations with local community engagement, impact assessments, and development programs | 99, 137          | Yes                | 1, 2, 3, 4, 6, 8, 9, 10, 11, 13, 14, 15, 16, 17 |
...
|-------------|-------------------|--------------------|---------------------------------------|
| **Anti-corruption** |                   |                    |                                       |
| G4-DMA      | Disclosure on Management Approach | 36-37            | -                  |                                       |
...
| G4-DMA      | Disclosure on Management Approach | 60-63            | -                  |                                       |
...
| G4-DMA      | Disclosure on Management Approach | 56, 60           | -                  |                                       |
...
| G4-DMA      | Disclosure on Management Approach | 56, 58-60        | -                  |                                       |
